...
//         <Typography variant="body1">Crypto Page</Typography>
//       </Box>
//     </div>
//   );
// };
...
export const Crypto = () => {
  ...
  useEffect(() => {
    ...
    fetchCryptos();
  }, [selectedCategory, monetaryUnit, page]);
  ...
  useEffect(() => {
    const fetchUnits = async () => {
      const url =
      `${COINGEKO_API_URL}simple/supported_vs_currencies`;
      const response = await axios.get(url);
  ...
  return (
    <Container>
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right" sx={{fontWeight:'bold'}}>1h</TableCell>
              <TableCell align="right" sx={{fontWeight:'bold'}}>24h</TableCell>
              <TableCell align="right" sx={{fontWeight:'bold'}}>7d</TableCell>

              <TableCell align="right" sx={{fontWeight:'bold'}}>24h Volume</TableCell>
              <TableCell align="right" sx={{fontWeight:'bold'}}>
                ...
                <TableRow key={crypto.id}>
                  ...
                  <TableCell align="right">
                    {crypto.current_price.toLocaleString("en-US", {
                      style: "currency",
                      currency: monetaryUnit.toUpperCase(),
                    })}
                  </TableCell>
                  <TableCell
                    align="right"
      ...
      <Pagination RowsPerPageList={RowsPerPageList}
