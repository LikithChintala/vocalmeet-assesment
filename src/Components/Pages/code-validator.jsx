  ...
  export const CodeValidator = () => {
    ...
    return (
      ...
      <Box p={5} textAlign="center">
        <Typography variant="subtitle1" sx={{fontWeight:'bold'}}>CodeValidator</Typography>
        ...
        {showText && (
          <Typography>
            Entered text is
            {isValid ? (
              <Typography sx={{fontWeight:'bold',color:'green'}}>Valid</Typography>
            ) : (
                <Typography sx={{fontWeight:'bold',color:'red'}}>InValid</Typography>
